---
tags: [Lux Node APIs]
description: This page is an overview of the Info API associated with Lux Node.
...
Given a blockchain’s alias, get its ID. (See [`admin.aliasChain`](/reference/node/admin-api.md#adminaliaschain).)
