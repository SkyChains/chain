---
tags: [Lux Node APIs]
description: This page is an overview of the Admin API associated with Lux Node.
...
enabled, use [config flag `--api-admin-enabled=true`](/nodes/configure/node-config-flags.md#--api-admin-enabled-boolean).
...
:::note Aliasing a chain can also be done via the [Node API](/nodes/configure/node-config-flags.md#--chain-aliases-file-string).
