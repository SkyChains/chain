...
containerID=$(docker run --name="net_outage_simulation" --memory="12g" --memory-reservation="11g" --cpus="6.0" --net=controlled-net -p 9650:9650 -p 9651:9651 -v /var/lib/node/db:/db -d SkyChains/chain:latest /node/build/luxd --db-dir /db --http-host=0.0.0.0)
