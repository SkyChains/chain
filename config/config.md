...
For an example of a JSON representation of genesis data, see [genesis_local.json](https://github.com/SkyChains/chain/blob/master/genesis/genesis_local.json).
...
Defaults to `2000000000000` (2,000 LUX) on Mainnet. Defaults to `5000000` (.005 LUX) on Test Net.
