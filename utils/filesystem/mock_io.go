...
// Source: github.com/SkyChains/chain/utils/filesystem (interfaces: Reader)
//
// Generated by this command:
//
//	mockgen -package=filesystem -destination=utils/filesystem/mock_io.go github.com/SkyChains/chain/utils/filesystem Reader
//
