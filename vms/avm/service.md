...
with [`avm.importKey`](/reference/node/x-chain/api.md#avmimportkey).
...
[`avm.createVariableCapAsset`](/reference/node/x-chain/api.md#avmcreatevariablecapasset).
...
[`avm.createNFTAsset`](/reference/node/x-chain/api.md#avmcreatenftasset).
...
Endpoint deprecated as of [**v1.9.12**](https://github.com/SkyChains/chain/releases/tag/v1.9.12).
