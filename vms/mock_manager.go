...
// Source: github.com/SkyChains/chain/vms (interfaces: Factory,Manager)
//
// Generated by this command:
//
//	mockgen -package=vms -destination=vms/mock_manager.go github.com/SkyChains/chain/vms Factory,Manager
//
