...
// Source: github.com/skychains/chain/vms/platformvm/state (interfaces: Chain,Diff,State,Versions)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/platformvm/state/mock_state.go github.com/skychains/chain/vms/platformvm/state Chain,Diff,State,Versions
//
...
import (
	...
	validators "github.com/skychains/chain/snow/validators"
	logging "github.com/skychains/chain/utils/logging"
	lux "github.com/skychains/chain/vms/components/lux"
	block "github.com/skychains/chain/vms/platformvm/block"
	fx "github.com/skychains/chain/vms/platformvm/fx"
	status "github.com/skychains/chain/vms/platformvm/status"
...
func (m *MockChain) AddRewardUTXO(arg0 ids.ID, arg1 *lux.UTXO) {
	m.ctrl.T.Helper()
...
// AddRewardUTXO mocks base method.
func (m *MockDiff) AddRewardUTXO(arg0 ids.ID, arg1 *lux.UTXO) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddRewardUTXO", arg0, arg1)
}
...
// AddRewardUTXO mocks base method.
func (m *MockState) AddRewardUTXO(arg0 ids.ID, arg1 *lux.UTXO) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddRewardUTXO", arg0, arg1)
}
...
func (m *MockState) GetRewardUTXOs(arg0 ids.ID) ([]*lux.UTXO, error) {
	m.ctrl.T.Helper()
