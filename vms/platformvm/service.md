---
tags: [P-Chain, Platform Chain, Lux Node APIs]
description: This page is an overview of the P-Chain API associated with Lux Node.
sidebar_label: API
...
- `validators`:
  ...
  - `delegators` is the list of delegators to this validator.
    ...
    - `stakeAmount` is the amount of nLUX this delegator staked.
...
Returns the maximum amount of nLUX staking to the named node during a particular time period.
