...
// Source: github.com/SkyChains/chain/x/sync (interfaces: NetworkClient)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_network_client.go github.com/SkyChains/chain/x/sync NetworkClient
//
