...
// Source: github.com/SkyChains/chain/snow/uptime (interfaces: Calculator)
//
// Generated by this command:
//
//	mockgen -package=uptime -destination=snow/uptime/mock_calculator.go github.com/SkyChains/chain/snow/uptime Calculator
//
