...
// Source: github.com/skychains/chain/snow/validators (interfaces: State)
//
// Generated by this command:
//
//	mockgen -package=validators -destination=snow/validators/mock_state.go github.com/skychains/chain/snow/validators State
//
