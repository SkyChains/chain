...
// Source: github.com/SkyChains/chain/database (interfaces: Iterator)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_iterator.go github.com/SkyChains/chain/database Iterator
//
